 ...
 * @author uyangjie
 */
public class DingTextTalkNotifier extends Notifier implements SimpleBuildStep {
    ...
    public DingTextTalkNotifier(String accessToken, String content, String atMobiles, Boolean isAtAll) {
    ...
    public void perform(@Nonnull Run<?, ?> run, @Nonnull FilePath filePath, @Nonnull Launcher launcher, @Nonnull TaskListener taskListener) throws InterruptedException, IOException {
        if (!StringUtils.isBlank(content)) {
            ...
            sendMessage(TextMessage.builder()
                                   .text(content)
                                   .atMobiles(list)
                                   .isAtAll(isAtAll)
                                   .build());
